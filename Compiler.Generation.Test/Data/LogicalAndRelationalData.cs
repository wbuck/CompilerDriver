    ...
    public LogicalAndRelationalData()
    {
        ...
        (
            ...
            GetExpected([
                ...
                new Mov(One, Stack(-16)),
                new Binary(Instructions.Add.Operator, Imm(5), Stack(-16)),
                new Mov(Stack(-16), R10.Register),
                new Cmp(R10.Register, Stack(-12)),
        ...
        (
            ...
            GetExpected([
                AllocateStack(16),
                new Mov(Imm(15), R11.Register),
                new Cmp(Imm(10), R11.Register),
                new Mov(Zero, Stack(-4)),
                new SetConditional(GreaterThan.Code, Stack(-4)),
                new Mov(Stack(-4), Ax.Register),
                Ret.Instruction        
        ...
        (
            ...
            GetExpected([
                ...
                new JmpConditional(Equal.Code, $".{TackyConstants.AND_WHEN_ZERO_LABEL}1"),
                new Mov(Imm(2), Stack(-8)),
                new Binary(Instructions.Add.Operator, One, Stack(-8)),
                new Cmp(One, Stack(-8)),
                new Mov(Zero, Stack(-12)),
                new SetConditional(GreaterThan.Code, Stack(-12)),
                Mov(Imm(3), R11.Register),
                new Cmp(Stack(-12), R11.Register),
                new Mov(Zero, Stack(-16)),
                ...
                new Binary(Instructions.Add.Operator, One, Stack(-24)),
