    ...
    {        
        ...
        (
            ...
            GetExpected([
                ...
                new Binary(Instructions.Add.Operator, Imm(3), Stack(-16)),
        ...
        (
            ...
            GetExpected([
                ...
                new Binary(Instructions.Add.Operator, Imm(1), Stack(-12)),
                new Mov(Imm(3), Ax.Register),
                Cdq.Instruction,
                new Div(Stack(-12)),
        ...
        (
            ...
            GetExpected([
                ...
                new Binary(Instructions.Add.Operator, Imm(4), Stack(-4)),
        ...
        (
            ...
            GetExpected([
                ...
                new Mov(Imm(2), Stack(-8)),
                new Mov(Stack(-4), R10.Register),
                new Binary(Instructions.Add.Operator, R10.Register, Stack(-8)),
                new Mov(Stack(-8), Ax.Register),
                Ret.Instruction                
            ])
        );
        ...
        (
            ...
            GetExpected([
                ...
                new Mov(Stack(-4), R10.Register),
                new Mov(R10.Register, Stack(-8)),
                new Binary(Instructions.Add.Operator, Imm(3), Stack(-8)),
                new Mov(Stack(-8), Ax.Register),
                Ret.Instruction                
            ])
        );
        ...
        (
            ...
            GetExpected([
                AllocateStack(16),
                new Mov(Imm(1), Stack(-4)),
                new Binary(Instructions.Add.Operator, Imm(1), Stack(-4)),
                new Mov(Stack(-4), R10.Register),
                new Mov(R10.Register, Stack(-8)),
