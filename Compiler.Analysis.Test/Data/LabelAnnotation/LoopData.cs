...
public class LoopData : DataBase
{
    public LoopData()
    {
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("i.0", Const(0)),
                new WhileNode
                (
                    Const(1),
                    Compound
                ...
                new VariableDeclarationNode("j.1", Const(10)),
                new WhileNode
                (
                    Const(1),
                    Compound
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("b.0", Const(20)),
                new ForNode
                (
        ...
        (
            ...
            (
                ...
                new ForNode
                (
                    new VariableDeclarationNode("i.1", Const(0)),
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("x.0", Const(100)),
                new WhileNode
                (
                    Const(1),
                    Compound
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("ans.0", Const(0)),
                new ForNode
                (
                    new VariableDeclarationNode("i.1", Const(0)),
                    new BinaryNode(LessThanNode.Operator, Var("i.1"), Const(10)),
                    ...
                    new ForNode
                    (
                        new VariableDeclarationNode("j.2", Const(0)),
