...
public class LoopData : DataBase
{
    public LoopData()
    {
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("result.0", Const(0)),
                new GotoNode("label"),
                new WhileNode
                (
                    Const(0),
        ...
        (
            ...
            (
                new VariableDeclarationNode("i.0", Const(0)),
                new VariableDeclarationNode("j.1", Const(0)),
                new VariableDeclarationNode("k.2", Const(1)),
                new ForNode
                (
                    new VariableDeclarationNode("i.3", Const(100)),
                    new BinaryNode(GreaterThanNode.Operator, Var("i.3"), Const(0)),
                    new UnaryNode(PostfixDecrementNode.Operator, Var("i.3")),
                    Compound
                        (
                            new VariableDeclarationNode("i.4", Const(1)),
