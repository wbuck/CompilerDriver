    ...
    public CompoundStatementData()
    {
        ...
        (
            ...
            (
                ...
                Compound(new VariableDeclarationNode("a.1", new AssignmentNode(Var("a.1"), Const(4)))),
                Ret(Var("a.0"))
            )
        );       
        Add
        (
            ...
            (
                ...
                Compound
                (
                    new VariableDeclarationNode("a.1", new AssignmentNode(Var("a.1"), Const(4))),
                    Ret(Var("a.1"))
                )
            )
        );
        ...
        (
            ...
            (
                ...
                Compound(new VariableDeclarationNode("b.1", new AssignmentNode(Var("a.0"), Const(1)))),
                Ret(Var("a.0"))
            )
        );
        Add
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("ten.0", Const(10)),
                Compound(),
        ...
        (
            ...
            (
                ...
                new VariableDeclarationNode("b.1"),
                Compound
                (
                   new ExpressionNode
                   (
                   ...
                   new VariableDeclarationNode("a.2", Const(7)),
                   new ExpressionNode
                   (
                       new AssignmentNode
                       (
        ...
        (
            ...
            (
                ...
                Compound
                (
                    new VariableDeclarationNode("a.1", Const(1)),
                    Ret(Var("a.1"))
                )
            )
        );
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("x.0", Const(4)),
                Compound(new VariableDeclarationNode("x.1")),
                Ret(Var("x.0"))
            )
        );
        Add
        (
            ...
            (
                ...
                Compound
                (
                    new VariableDeclarationNode("b.1", Const(4)),
                    new ExpressionNode(new AssignmentNode(Var("a.0"), Var("b.1")))
                ),
                Compound
                (
                    new VariableDeclarationNode("b.2", Const(2)),
                    new ExpressionNode
                    (
                        new AssignmentNode
                        (
        ...
        (
            ...
            (
                ...
                (
                    ...
                    Compound
                        (
                            new VariableDeclarationNode("c.2", Const(3)),
                            new IfNode
                            (
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("x.0"),
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("a.0", Const(5)),
                new IfNode
                (
                    ...
                    (
                        ...
                        new VariableDeclarationNode("a.1", Const(5)),
                        new IfNode
                        (
        ...
        (
            ...
            (
                ...
                (
                    ...
                    new VariableDeclarationNode("a.1", Const(4)),
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("x.0", Const(5)),
                new GotoNode("inner"),
                Compound
                (
                    new VariableDeclarationNode("x.1", Const(0)),
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("a.0", Const(10)),
                ...
                (
                    ...
                    Compound
                         (
                             new VariableDeclarationNode("a.2", Const(1)),
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("sum.0", Const(0)),
                new IfNode
                (
                    Const(1),
                    Compound
                ...
                (
                    ...
                    (
                        ...
                        new VariableDeclarationNode("a.2", Const(6)),                        
                        new ExpressionNode
                        (
                            new AssignmentNode
                            (
