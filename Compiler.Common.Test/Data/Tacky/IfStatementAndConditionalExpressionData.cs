...
public class IfStatementAndConditionalExpressionData : DataBase
{
    public IfStatementAndConditionalExpressionData()
    {
        ...
        (
            ...
            GetExpected([
                new TackyCopy(Const(1), Var("x.0")),
                new TackyJump("post_declaration"),
                new TackyCopy(Const(0), Var("x.0")),
                new TackyCopy(Var("x.0"), Var("i.1")),
                new TackyLabel("post_declaration"),
        ...
        (
            ...
            """,
            GetExpected([
                new TackyJump("labelB"),
                new TackyLabel("labelA"),
                new TackyLabel("labelB"),
                Ret(Const(5)),
                Ret(Const(0))
            ])
        );
        ...
        (
            ...
            GetExpected([
                new TackyCopy(Const(1), Var("a.0")),
                new TackyLabel("label_if"),
                new TackyJumpIfZero(Var("a.0"), $".{TackyConstants.ELSE_LABEL}2"),
                new TackyJump("label_expression"),
                new TackyJump($".{TackyConstants.IF_END_LABEL}1"),
                new TackyLabel($".{TackyConstants.ELSE_LABEL}2"),
                new TackyJump("label_empty"),
                new TackyLabel($".{TackyConstants.IF_END_LABEL}1"),
                new TackyLabel("label_goto"),
                new TackyJump("label_return"),
                new TackyJumpIfZero(Const(0), $".{TackyConstants.IF_END_LABEL}3"),
                new TackyLabel("label_expression"),
                new TackyCopy(Const(0), Var("a.0")),
                new TackyLabel($".{TackyConstants.IF_END_LABEL}3"),
                new TackyJump("label_if"),
                new TackyLabel("label_return"),
                Ret(Var("a.0")),
                new TackyLabel("label_empty"),
                new TackyCopy(Const(100), Var("a.0")),
                new TackyJump("label_goto")
            ])
        );
        Add
        (
            ...
            """,
            GetExpected([
                new TackyJump("_foo_1_"),
                Ret(Const(0)),
                new TackyLabel("_foo_1_"),
                Ret(Const(1))
            ])
        );
        Add
        ...
        (
            ...
            """,
            GetExpected([
                new TackyJump("label2"),
                Ret(Const(0)),
                new TackyLabel("label1"),
                new TackyLabel("label2"),
                Ret(Const(1))
            ])
        );
    }
