...
public class LocalVariableData : DataBase
{
    public LocalVariableData()
    {
        ...
        (
            ...
            """,
            GetExpected(
                new DeclarationNode("first_variable", Const(1)),
                new DeclarationNode("second_variable", Const(2)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a", Const(2147483646)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a", new AssignmentNode(Var("a"), Const(5))),
                Ret(Var("a"))
            )
        );
        Add
        ...
        (
            ...
            (
                ...
                new DeclarationNode("b", new AssignmentNode(Var("a"), Const(0))),
                Ret(Var("b"))
            )
        );
        Add
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a", new UnaryNode(NegateNode.Operator, Const(2593))),
                new ExpressionNode
                (
                    new AssignmentNode
                   (
                ...
                new DeclarationNode("b", new UnaryNode(NegateNode.Operator, Var("a"))),
                Ret(Var("b"))
            )
        );
        Add
        (
            ...
            GetExpected
            (
                new DeclarationNode("return_val", Const(3)),
                new DeclarationNode("void2", Const(2)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a", new BinaryNode(LogicalAndNode.Operator, Const(0), Var("a"))),
                Ret(Var("a"))
            )
        );
    }
