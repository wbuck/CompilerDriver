...
public class CompoundOperatorData : DataBase
{
    public CompoundOperatorData()
    {
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("b", Const(10)),
        ...
        (
            ...
            (
                ...
                new DeclarationNode("b", new BinaryNode
                (
                    AdditionNode.Operator, 
                    Const(3), 
                    new UnaryNode(PostfixIncrementNode.Operator, Var("a"))
                )),
                new DeclarationNode("c", new BinaryNode
                (
                    AdditionNode.Operator, 
                    Const(4), 
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a", Const(15)),
                new DeclarationNode("b", new BitwiseNode(BitwiseXorNode.Operator, Var("a"), Const(5))),
        ...
        (
            ...
            (
                ...
                new DeclarationNode("b", Const(5)),
                new DeclarationNode("c", Const(8)),
                Ret
                (
                    new BitwiseNode
                    (
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("var_to_shift", Const(1234)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a", Const(250)),
                new DeclarationNode("b", Const(200)),
                new DeclarationNode("c", Const(100)),
                new DeclarationNode("d", Const(75)),
                new DeclarationNode("e", new UnaryNode(NegateNode.Operator, Const(25))),
                new DeclarationNode("f", Const(0)),
                new DeclarationNode("x", Const(0)),
                Expr
                (
                    new AssignmentNode
        ...
        (
            ...
            (     
                new DeclarationNode("a", Const(10)),
                new DeclarationNode("b", Const(12)),
                new ExpressionNode
                (
                    new AdditionAssignmentNode
                    (
                ...
                new DeclarationNode("c", Const(14)),
                new ExpressionNode
                (
                    new SubtractionAssignmentNode
                    (
                ...
                new DeclarationNode("d", Const(16)),
                new ExpressionNode
                (
                    new DivisionAssignmentNode
                    (
        ...
        (
            ...
            (
                ...
                new DeclarationNode("y", new AdditionAssignmentNode(Var("x"), Const(3))),
                Ret(Const(0))
            )
        );
        Add
        (
            ...
            GetExpected
            (
                new DeclarationNode("to_and", Const(3)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a", Const(11)),
                new DeclarationNode("b", Const(12)),
                new ExpressionNode(
                ...
                new ExpressionNode(
                    new RightShiftAssignmentNode(
                        Var("d"), 
                        new BinaryNode(LogicalOrNode.Operator, Var("c"), Var("d")))),
                new DeclarationNode("e", Const(18)),
                new ExpressionNode(
        ...
        (
            ...
            (
                ...
                new DeclarationNode("c", Const(100)),
                new DeclarationNode("d", Const(75)),
                new DeclarationNode("e", Const(50)),
                new DeclarationNode("f", Const(25)),
                new DeclarationNode("g", Const(10)),
                new DeclarationNode("h", Const(1)),
                new DeclarationNode("j", Const(0)),
                new DeclarationNode("x", Const(0)),
                new ExpressionNode
                (
                    new AssignmentNode
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("to_or", Const(1)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("to_shiftl", Const(3)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("to_shiftr", Const(382574)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("to_xor", Const(7)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("to_divide", Const(8)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("to_subtract", Const(10)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("to_mod", Const(5)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("to_multiply", Const(4)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("to_add", Const(0)),
        ...
        (
            ...
            (
                new DeclarationNode("a", Const(1)),
                new DeclarationNode("b", Const(2)),
                new DeclarationNode("c", new UnaryNode(PrefixIncrementNode.Operator, Var("a"))),
                new DeclarationNode("d", new UnaryNode(PrefixDecrementNode.Operator, Var("b"))),
                Ret
                (
                    new BinaryNode
                    (
