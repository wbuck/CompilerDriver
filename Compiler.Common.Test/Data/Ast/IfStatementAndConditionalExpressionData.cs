    ...
    public IfStatementAndConditionalExpressionData()
    {
        ...
        (
            ...
            GetExpected(
                ...
                new DeclarationNode("flag", Const(0)),
                Ret
                (
                    new ConditionalNode
                    (
        ...
        (
            ...
            """,
            GetExpected(
                new DeclarationNode("flag", Const(1)),
                new DeclarationNode("a", Const(0)),
        ...
        (
            ...
            """,
            GetExpected(
                new DeclarationNode("a", new ConditionalNode
                    (
                        Const(1),
