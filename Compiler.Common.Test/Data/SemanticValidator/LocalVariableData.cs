...
public class LocalVariableData : DataBase
{
    public LocalVariableData()
    {
        ...
        (
            ...
            """,
            GetExpected(
                new DeclarationNode("first_variable.0", Const(1)),
                new DeclarationNode("second_variable.1", Const(2)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a.0", Const(2147483646)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a.0", new AssignmentNode(Var("a.0"), Const(5))),
                Ret(Var("a.0"))
            )
        );
        Add
        ...
        (
            ...
            (
                ...
                new DeclarationNode("b.1", new AssignmentNode(Var("a.0"), Const(0))),
                Ret(Var("b.1"))
            )
        );
        Add
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a.0", new UnaryNode(NegateNode.Operator, Const(2593))),
                new ExpressionNode
                (
                    new AssignmentNode
                    (
                ...
                new DeclarationNode("b.1", new UnaryNode(NegateNode.Operator, Var("a.0"))),
                Ret(Var("b.1"))
            )
        );
        Add
        (
            ...
            GetExpected
            (
                new DeclarationNode("return_val.0", Const(3)),
                new DeclarationNode("void2.1", Const(2)),
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a.0", Const(1)),
                new DeclarationNode("b.1", Const(0)),
                new ExpressionNode
                (
                    new AssignmentNode
        ...
        (
            ...
            GetExpected
            (
                new DeclarationNode("a.0", new BinaryNode(LogicalAndNode.Operator, Const(0), Var("a.0"))),
                Ret(Var("a.0"))
            )
        );
    }
