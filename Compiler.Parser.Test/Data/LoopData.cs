...
public class LoopData : DataBase
{
    public LoopData()
    {
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("i", Const(2147483642)),
                new DoWhileNode
                (
                    NullNode.Statement, 
                    new BinaryNode
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("i", Const(0)),
                new WhileNode
                (
                    Const(1),
                    Compound
                ...
                new VariableDeclarationNode("j", Const(10)),
                new WhileNode
                (
                    Const(1),
                    Compound
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("a", Const(12345)),
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("shadow", Const(1)),
                new VariableDeclarationNode("acc", Const(0)),
                new ForNode
                (
                    new VariableDeclarationNode("shadow", Const(0)),
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("b", Const(20)),
                new ForNode
                (
        ...
        (
            ...
            (
                new ForNode
                (
                    new VariableDeclarationNode("i", Const(400)),
                    null,
                    new AssignmentNode
                        (
                            Var("i"),
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("a", new UnaryNode(NegateNode.Operator, Const(2147483647))),
                new ForNode
                (
                    null,
                    new BinaryNode
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("i", Const(100)),
                new VariableDeclarationNode("sum", Const(0)),
                new DoWhileNode
                (
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("i", Const(1)),
                new ForNode
                (
        ...
        (
            ...
            GetExpected
            (
                new VariableDeclarationNode("result", Const(0)),
                new GotoNode("label"),
                new WhileNode
                (
                    Const(0),
