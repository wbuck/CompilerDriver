...
public sealed partial record SubtractionAssignmentToken(int Index) : IToken
{
    public TokenType Type => TokenType.SubtractionAssignment;
    public int Length => 2;
    ...
    public static IToken? Parse(ref ReadOnlySpan<char> value, int offset)
    {
        ...
        return new SubtractionAssignmentToken(match.Index + offset);       
    }
}