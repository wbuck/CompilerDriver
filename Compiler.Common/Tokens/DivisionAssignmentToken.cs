...
public sealed partial record DivisionAssignmentToken(int Index) : IToken
{
    public TokenType Type => TokenType.DivisionAssignment;
    public int Length => 2;
    ...
    public static IToken? Parse(ref ReadOnlySpan<char> value, int offset)
    {
        ...
        return new DivisionAssignmentToken(match.Index + offset);       
    }
}