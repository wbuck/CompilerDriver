...
public sealed partial record LessThanOrEqualToToken(int Index) : IToken
{
    public TokenType Type => TokenType.LessThanOrEqual;
    public int Length => 2;
    ...
    public static IToken? Parse(ref ReadOnlySpan<char> value, int offset)
    {
        ...
        return new LessThanOrEqualToToken(match.Index + offset);       
    }
}