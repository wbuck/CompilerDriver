...
public sealed partial record BitwiseOrAssignmentToken(int Index) : IToken
{
    public TokenType Type => TokenType.BitwiseOrAssignment;
    public int Length => 2;
    ...
    public static IToken? Parse(ref ReadOnlySpan<char> value, int offset)
    {
        ...
        return new BitwiseOrAssignmentToken(match.Index + offset);       
    }
}