...
public sealed partial record BitwiseXorAssignmentToken(int Index) : IToken
{
    public TokenType Type => TokenType.BitwiseXorAssignment;
    public int Length => 2;
    ...
    public static IToken? Parse(ref ReadOnlySpan<char> value, int offset)
    {
        ...
        return new BitwiseXorAssignmentToken(match.Index + offset);       
    }
}